    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb-4">
            ...
            <div class="title-actions">
                <a href="{{ route('job.admin.applicants.create') }}" class="btn btn-primary">{{ __("Add New Applicant") }}</a>
            </div>
        </div>
                                                ...
                                                <td>
                                                    @if($row->user)
                                                        <a href="{{ $row->candidateInfo->getDetailUrl().'?apply_id='.$row->id }}" target="_blank" class="candidate">
                                                            <img src="{{ $row->user->getAvatarUrl() }}" style="border-radius: 50%" class="company-logo" />
                                                            {{ !empty($row->user->getDisplayName()) ? $row->user->getDisplayName() : $row->user->id }}
                                                        </a>
                                                    @endif
                                                </td>
                                                <td class="title">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                            @if($row->candidateInfo)
                                                                <a class="dropdown-item" href="{{ route('candidate.detail', ['slug' => $row->candidateInfo->slug ?? $row->candidateInfo->id ]) }}">{{ __("View Candidate Profile") }}</a>
                                                            @endif
