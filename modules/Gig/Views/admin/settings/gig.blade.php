        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <label ><input type="checkbox" name="gig_require_plan" value="1" @if(setting_item('gig_require_plan')) checked @endif > {{__("Yes Please")}}</label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="" >{{__("Maximum posting gigs")}}</label>
                    <div class="form-controls">
                        <input type="number" name="gig_max_posts" value="{{setting_item('gig_max_posts', '')}}" class="form-control">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__('Review option')}}</h3>
        <p class="form-group-desc">{{__('Change gig review config')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group" >
                    <label>{{__('GIG is created by candidate must be approved by admin')}}</label>
                    <div class="form-controls">
                        <div class="form-controls">
                            <label><input type="checkbox" name="gig_need_approve" value="1" @if(setting_item('gig_need_approve')) checked @endif >
